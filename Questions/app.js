...
var questions = [
    ...
    new Question("An attack that refers to a broad class of attack vectors that allow an attacker to supply untrusted input to a program, which gets processed by an interpreter as part of a command or query which alters the course of execution of that program", ["Cross-Site Scripting", "Injection", "Security Misconfiguration", "Broken Access Control"], "Injection"),
    new Question("This attack can occur when an application does not adequately protect sensitive information from being disclosed to attackers.", ["Broken Authentication", "Broken Access Control", "Sensitive Data Exposure", "Using Components with Known Vulnerabilities"], "Sensitive Data Exposure"),
    new Question("Sensitive Data Exposure", ["Broken Access Control", "Security Misconfiguration", "Injection", "Sensitive Data Exposure"], "Broken Access Control"),
    new Question("This attack can allow an attacker to either capture or bypass the authentication methods that are used by a web application.", ["Insecure Deserialization", "Broken Access Control", "Sensitive Data Exposure", "Broken Authentication"], "Broken Authentication"),
    new Question("Is a type of injection security attack in which an attacker injects data, such as a malicious script, into content from otherwise trusted websites.", ["External Entities (XXE)", "Cross-Site Scripting (XSS)", "Sensitive Data Exposure", "Security Misconfiguration"], "Cross-Site Scripting (XSS)"),
    new Question("Enables attackers to disclose normally protected files from a server or connected network.", ["Insecure Deserialization", "Insufficient Logging & Monitoring", "External Entities (XXE)", "Using Components with Known Vulnerabilities"], "External Entities (XXE)"),
    new Question("This attack occur due to insecure default configuration, poorly documented default configuration, or poorly documented side-effects of optional configuration.", ["Security Misconfiguration", "Sensitive Data Exposure", "Injection", "Broken Authentication"], "Security Misconfiguration"),
    new Question("Is a vulnerability which occurs when untrusted data is used to abuse the logic of an application, inflict a denial of service (DoS) attack.", ["Insecure Deserialization", "Using Components with Known Vulnerabilities", "Insufficient Logging & Monitoring", "External Entities (XXE)"], "Insecure Deserialization"),
    new Question("This attack occurs when the security-critical events aren’t logged properly, and the system is not monitoring the current happenings.", ["Using Components with Known Vulnerabilities", "Insufficient Logging & Monitoring", "External Entities (XXE)", "Security Misconfiguration"], "Insufficient Logging & Monitoring"),
    new Question("Some vulnerable components (e.g., framework libraries) can be identified and exploited with automated tools, expanding the threat agent pool beyond targeted attackers to include chaotic actors.", ["External Entities (XXE)", "Insufficient Logging & Monitoring", "Insufficient Logging & Monitoring", "Using Components with Known Vulnerabilities"], "Using Components with Known Vulnerabilities")
